...
const SKIP_REASONS = [
  ...
  { key: '3', reason: 'bad_clip', label: 'bad clip' },
];
...
function beginSkip() {
  ...
  state.mode = 'skipping';
  state.capturedFrame = null;
  setBanner('SKIP: [1] occluded · [2] unclear · [3] bad clip · [Esc] cancel', 'skipping');
  updateCapturePanel();
}
...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  document.getElementById('btn-skip-badclip').addEventListener('click', () => skipWith('bad_clip'));
